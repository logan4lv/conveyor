...
import com.kpgrowing.conveyer.common.queue.QueueEvent;
import com.kpgrowing.conveyer.common.queue.QueueEventListener;
import com.kpgrowing.conveyer.common.queue.policy.DefaultRetryPolicy;
import com.kpgrowing.conveyer.common.queue.policy.WaitingRepeatGroupPolicy;
...
import com.kpgrowing.conveyer.schedule.leader.GroupTimerManager;
import com.kpgrowing.conveyer.schedule.leader.SchedulerLeaderLatch;
import com.kpgrowing.conveyer.schedule.leader.SchedulerLeaderLatchListener;
import com.kpgrowing.conveyer.schedule.zookeeper.ZookeeperSchedulerLeaderLatch;
...
import static com.kpgrowing.conveyer.common.queue.QueueEvent.Type.GROUP_COMPLETE;
...
public class Dispatcher implements SchedulerLeaderLatchListener {
    ...
    private class JobSender extends LoganThread {
